...
type GenericCommandObject = { command: string; payload: any };
...
export type FsCommand = (args: string[], context: CommandContext) => CommandResult;
...
export type Command = (...args: any[]) => CommandResult;
