...
export default {
  darkMode: ["class"], // Keep dark mode option, but we'll default to dark
  content: [
    "./pages/**/*.{ts,tsx}",
    "./components/**/*.{ts,tsx}",
    "./app/**/*.{ts,tsx}",
  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        input: "hsl(var(--input))",
        ring: "hsl(var(--ring))",
        background: "hsl(var(--background))", // Will be overridden in index.css for terminal
        foreground: "hsl(var(--foreground))", // Will be overridden
